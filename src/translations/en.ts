...
export const enTranslations = {
  ...
  'howItWorks.rsa.description': 'An extremely strong 4096 bits public-key system used to securely wrap (or "seal") the AES key into the envelope. Now the envelope was sealed and only the recipient can open the envelope.',
