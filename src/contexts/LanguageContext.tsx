...
const translations = {
  ...
  ro: {
    ...
    'howItWorks.aes.title': 'AES-256-GCM',
    'howItWorks.aes.description': 'un algoritm de criptare rapid și sigur care blochează fiecare mesaj folosind o cheie unică, generată aleatoriu. De asemenea, oferă autentificare încorporată, astfel încât să știi că mesajul nu a fost modificat.',
    'howItWorks.rsa.title': 'RSA 4096',
